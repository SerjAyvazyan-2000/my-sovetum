...
const CreateExpertStep1: FC = () => {
    ...
    return <div
        ...
        <div className='flex mx-[16px] gap-[16px] border border-[#F4F4F8]  flex-col mt-[36px]  py-[24px] px-[16px] bg-[#FFFFFF] rounded-[20px]'>
        ...
        <div className='flex mx-[16px] gap-[14px] border border-[#F4F4F8]  flex-col mt-[12px]  py-[12px] px-[16px] bg-[#FFFFFF] rounded-[20px]'>
            <div className='min-h-[144px] border-dashed border-2  border-[#D9D9E2] rounded-[12px]'>
                <label htmlFor="createAvatar" className="cursor-pointer flex flex-col items-center justify-center">
                    ...
                    <span className='font-medium mt-[8px] text-[12px] leading-[100%] opacity-[.6] text-[#1E112E]'>Выберите изображение с устройства</span>
                </label>
        ...
        <div
            className='flex  rounded-tl-[16px] rounded-tr-[16px]   w-full  gap-[14px] border border-[#F4F4F8]  flex-col mt-[12px] px-[16px]  pt-[16px] pb-[20px] bg-[#FFFFFF] '>
